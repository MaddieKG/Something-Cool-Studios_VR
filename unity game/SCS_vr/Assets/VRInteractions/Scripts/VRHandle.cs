...
public class VRHandle : MonoBehaviour {
	...
	/// </summary>
	private GameObject 		AttachedController;
	...
	void OnTriggerEnter(Collider _collider)
	{
        ...
        GameObject controller = controllerBody.gameObject.GetComponent<GameObject> ();
	...
	void HandleExit(Rigidbody _controllerBody)
	{
        ...
        GameObject controller = _controllerBody.gameObject.GetComponent<GameObject> ();
	...
	public void AttachTo(Rigidbody _controllerBody)
	{
		...
		if (controller == null)
			return;
		var device = OVRPlayerController.Input ((int)controller.index);
	...
	public void AttachTo(GameObject _controller)
	{
